...
if use_sdv:
    ...
    def ctgan_train(data=None, epochs=1000, printing=True, name='CTGAN_Scrubbed'):
        ...
        # Updated version
        three_two_constraint = Inequality(low_column_name='NrWgt3', high_column_name='NrWgt2', handling_strategy='reject_sampling')
        four_three_constraint = Inequality(low_column_name='NrWgt4', high_column_name='NrWgt3', handling_strategy='reject_sampling')
        five_four_constraint = Inequality(low_column_name='NrWgt5', high_column_name='NrWgt4', handling_strategy='reject_sampling')
        six_five_constraint = Inequality(low_column_name='NrWgt6', high_column_name='NrWgt5', handling_strategy='reject_sampling')
